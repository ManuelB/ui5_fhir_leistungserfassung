...
sap.ui.define(
    ...
    function (Control, jQuery, JSONModel, MessageToast, ResponsivePopover, List, DisplayListItem, Device) {
      ...
      return Control.extend('ui5fhirleistungserfassung.control.ExtScanner', {
        metadata: {
          manifest: 'json',
          properties: {
        ...
        getSettingsPopover: function () {
          if (!this.oSettingsPopover) {
            this.oSettingsPopover = sap.ui.xmlfragment(this.getId(), 'ui5fhirleistungserfassung.control.fragments.settingsPopover', this);
        ...
        _getScanDialog: function () {
          if (!this._oTD) {
            this._oTD = sap.ui.xmlfragment(this.getId(), 'ui5fhirleistungserfassung.control.fragments.scanDialog', this);
        ...
        _getInputDialog: function () {
          if (!this._oID) {
            this._oID = sap.ui.xmlfragment(this.getId(), 'ui5fhirleistungserfassung.control.fragments.inputDialog', this);
        ...
        _getDialogHeader: function () {
          if (!this._oHeader) {
            this._oHeader = sap.ui.xmlfragment(this.getId(), 'ui5fhirleistungserfassung.control.fragments.toolbar', this);
