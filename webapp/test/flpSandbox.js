		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ui5fhirleistungserfassung-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5fhirleistungserfassung-display": {
								"semanticObject": "ui5fhirleistungserfassung",
								"action": "display",
								"description": "Hier kann man für Patienten Leistungen erfassen und diese in SAP IS-H abspeichern.",
								"title": "Leistungserfassung",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5fhirleistungserfassung",
									"url": sap.ui.require.toUrl("ui5fhirleistungserfassung")
								}
							}
						}
					}
